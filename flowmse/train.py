...
if __name__ == '__main__':
     ...
     if args.no_wandb:
          ...
          if ode_class.__name__ == "FLOWMATCHING":
               name_save_dir_path = f"{ode_class.__name__}_weight_shat_{args.weight_shat}_weight_y_{args.weight_y}_sigma_min_{args.sigma_min}_sigma_max_{args.sigma_max}_T_rev_{args.T_rev}_t_eps_{args.t_eps}_dataset_{dataset}"
     ...
     trainer = pl.Trainer.from_argparse_args(
          ...
          logger=logger, log_every_n_steps=10, num_sanity_val_steps=0, max_epochs=350,
          callbacks=callbacks
     )
